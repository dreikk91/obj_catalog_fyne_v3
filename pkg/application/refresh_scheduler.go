...
func newSimAutoResetThrottle(prefs fyne.Preferences, historyKey string) simAutoResetThrottle {
...
func shouldAutoResetVodafoneSIM1(sim1 string) bool {
	return strings.TrimSpace(sim1) != "" && simoperator.IsVodafone(sim1)
}

func shouldAutoResetKyivstarSIM1(sim1 string) bool {
	return strings.TrimSpace(sim1) != "" && simoperator.IsKyivstar(sim1)
}
